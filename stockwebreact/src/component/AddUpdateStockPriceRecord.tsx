...
const AddStockPricesForDay =(props: Props) => {
    var stockPriceData: null|IStockPrice=null;
    //alert(" AddStockPricesForDay  =" + props.stockPriceToEditIndex.toString())
        ...
        <div className=".form-container ">
            ...
            <form onSubmit={onSubmitBtnHandler}>
                <table className="table_addprices"> 
                    <tbody>
                    <tr>  <td className="td_label"> <label>Ticker: </label>  </td> <td> <input type="text" value={ticker}  onChange={onTickerChangeHandler}/>  </td>  </tr>
...
export default AddStockPricesForDay;
