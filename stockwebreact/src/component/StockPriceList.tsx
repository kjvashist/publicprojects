...
type Props = {
    list: IStockPrice[];
    onDeleteRecordHandler: (data: IStockPrice) => void;
    onEditRecordHandler: (data: IStockPrice) => void;
};


const StockPriceList = (props: Props) => {
    const { list, onDeleteRecordHandler, onEditRecordHandler } = props;
                            ...
                            <tr key={stockPrice.ticker + stockPrice.priceDate.toString()}>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <input type="button" value="Delete" onClick={() => onDeleteRecordHandler(stockPrice)} />
                                    </div>
                                </td>
                            </tr>
                        );
